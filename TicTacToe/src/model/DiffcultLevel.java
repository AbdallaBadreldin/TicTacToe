 ...
 * @author Mahmoud
 */
public class DiffcultLevel {
       public static int evaluate(Label b[][]) {
       // Checking for Rows for X or O 
        ...
        //TODO: draw line method and show win or lose dialog
        return 0;
    }
    ...
    public static Boolean isMoveLeft(Label board[][]) {
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 3; j++) {
    ...
    public static Move findBestMove(Label board[][]) {
        int bestVal = -1000;
